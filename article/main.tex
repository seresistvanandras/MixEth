...
\begin{table}[H] 
	...
	\begin{tabular}{@{\extracolsep{6pt}}lcccc@{}} 
		...
		\toprule
		\hline
		&Deposit&\multicolumn{2}{c}{Shuffle}& Withdraw\\
		\cline{3-4}&&Shuffle upload&Challenge\\
		\hline
		\midrule
...
\begin{appendices}
	...
	Reduction to DDH has to be added here
\end{appendices}
