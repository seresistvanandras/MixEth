...
miximusWithdrawalCost = 1903305;
noOfMiximusWithdrawal=floor(blockGasLimit/miximusWithdrawalCost);
plotMiximus = noOfMiximusWithdrawal.* ones(length(participants),1);

mobiusWithdrawalCost = participants.*335714;
...
%plot(participants,  plotMiximus, 'Miximus', participants, plotMobius, participants, plotMixEth,'LineWidth',2);
plot(participants, plotMiximus,'DisplayName','Miximus','LineWidth',2);
hold on
plot(participants, plotMobius,'DisplayName', 'Möbius' ,'LineWidth',2);
plot(participants, plotMixEth, 'DisplayName', 'MixEth','LineWidth',2);
hold off
lgd = legend;
lgd.NumColumns = 1;
