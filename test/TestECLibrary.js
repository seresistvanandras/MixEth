...
contract('ECLibraryTest', function(accounts) {
    ...
    it("Scalar Multiplication: 5G with Buterin trick", function() {
        return ECLibraryTest.deployed().then(function(instance) {
            ContractInstance.ecMulV(Gx,Gy,'0x5','0x2F8BDE4D1A07209355B4A7250A5C5128E88B84BDDC619AB7CBA8D569B240EFE4','0xD8AC222636E5E3D6D4DBA9DDA6C9C426F788271BAB0D6840DCA87D3AA6AC62D6');
            return ContractInstance.equality.call();
        }).then(function(success) {
            assert.equal(true, success, "Scalar multiplication with ecrecover is not verified");
        });
    });
});
