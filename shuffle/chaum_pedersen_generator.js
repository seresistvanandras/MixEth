...
function proofGenerator(_G, _A, _B, _C, _privKey, _s) {
  ...
  let privKey = bigInt(_privKey,16);
  let s =  bigInt(_s.toString(16),16);

  let y1 = ec.keyFromPublic(_G,'hex').getPublic().mul(r);
  let y2 = B.mul(r);

  let z = rBigInt.add(privKey.multiply(s));
